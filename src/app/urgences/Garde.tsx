...
const Garde: FC = () => {
  ...
  return (
    <>
      <p className={classP}>
        <span className='font-semibold'>Un service de garde est organisé les di&shy;manches et jours fé&shy;riés</span> par le Conseil de l&apos;Ordre Dé&shy;partemen&shy;tal des Chi&shy;rur&shy;giens-Den&shy;ti&shy;stes.
      ...
      <p className={classP}>
        Vous pouvez également appeler ou vous rendre au service des Urgences du CHU de Mont&shy;pellier au <Link href="https://www.chu-montpellier.fr/fr/a-propos-du-chu/decouvrir/etablissements/gui-de-chauliac" target="_blank" rel="noopener noreferrer" className='underline font-semibold italic'>Ser&shy;vi&shy;ce de Chirur&shy;gie Maxil&shy;lo-Faciale/Sto&shy;matolo&shy;gie - Hô&shy;pi&shy;tal Gui de Chau&shy;liac</Link>.
      </p>
      <iframe 
